    ...
    <MainLayout>
      <div className="container px-4 py-12 md:py-24 max-w-md">
        ...
        <div className="glass-card rounded-xl p-6 lg:p-8 shadow-lg">
          <Tabs defaultValue="user" className="w-full" onValueChange={(value) => setUserType(value as "user" | "provider")}>
            ...
            <TabsContent value="provider">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="provider-remember" className="text-sm font-normal">
                    Remember me for 30 days
                  </Label>
                </div>
                <Button type="submit" className="w-full" disabled={loading}>
